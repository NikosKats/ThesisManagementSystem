...
<div class="container"> 
    ...
    <div class="jumbotron" style="background:#1CB186 !important">
        ...
        <p style="color:white;">Below you can create new diploma.</p>
    </div>
    ...
    <form  action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
       ...
       <?php
                     ...
                     if(!empty($_POST['option']))
            {
                ...
                $courses_string = implode(', ', $_POST['option']);
            ...
            else
            {
                ...
                {  
                    ...
                    $sql = "INSERT INTO diploma (title, teacher,teacher_id, student_number,goal,description,prerequisite_courses,prerequisite_knowledge,date_of_creation)
                    VALUES ('$title', '$teacher', '$teacher_id ','$student_number','$goal','$description','$courses_string','$prerequisite_knowledge','$date')";
     ...
     <div class="form-group">
       ...
       <input type="text" class="form-control" name="title" placeholder="Title" value="<?php if(isset($_SESSION['title'])) {echo $_SESSION['title'];}  ?>">
     ...
     <div class="form-group"> 
      ...
      <select name="student_number" class="form-control">
       ...
       <input type="text" class="form-control" id="goal" name="goal" placeholder="Goal" >
       <?php
     ...
     <div class="form-group">
       ...
       <textarea name="prerequisite_knowledge" id="prerequisite_knowledge" class="form-control" rows="5"></textarea>
       <?php
